        ...
        <div>
          <div class="paging">
            ...
            <a
              ...
              href="#"
              title="前一页"
              @click.prevent="gotoPage(parseInt(data.current) - 1)"
              >&lt;</a
            >
            <a
              ...
              :key="page"
              :class="{
                current: parseInt(data.current) === page,
                undisable: parseInt(data.current) == page,
              }"
              :title="'第' + parseInt(data.current) + '页'"
              href="#"
...
export default {
  ...
  methods: {
    ...
    gotoPage(page) {
      //console.log("12321321"+response.data.data)
